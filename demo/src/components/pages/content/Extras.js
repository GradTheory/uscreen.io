...
const Extras = () => {
  ...
  return (
    ...
    <div className=" bg-white shadow  py-8 px-10  relative   lg:w-full "style={{width:"140%",paddingTop:"10px"}}>
                  <div>
                    <div className="">
    ...
    <p>
      ...
      <div className="grid grid-flow-col auto-cols-max cardspan">
        <a href="#" className="pr-3">
          ...
          <span className="text text-sm pl-3 " style={{ color: "#3388FF" }}>
            Read the Guide
          </span>
        </a>
        <div>
          <a onClick={openModal} href="" className="pr-3">
            <span className="icon" style={{ alignItems: "center" }}>
              <svg
                className="w-5 h-5"
                fill="none"
            ...
            <span
                      ...
                      >
                         <Modal2 
                         msg={['Accompany your videos with additional resources, such as PDFs, documents, or','slide decks, using Extras.','' ,'This is the place to add nutrition guides, printable instructions, educational','slideshows, and more!']} 
         name="Take a tour"/>  
                      </span>
          </a>
