...
import LiveEvent from "./pages/content/LiveEvent";
import Collection from "./pages/content/Collection";
import Extras from "./pages/content/Extras"
import Categories from "./pages/content/Categories"
import Custom from "./pages/content/Custom filter";
    ...
    <Router>
      <div>
        <div className=" grid grid-flow-col justify-center   pr-34 pt-12  "   style={{ backgroundColor: "#f7fafc" }}>
          <div className="  bg-white  pt-3 sticky pr-3 justify-center top-0 shadow-md overflow-hidden  " style={{width:"100%"}}>
            <div className="flex grid pb-5">
              <ul className="text-sm leading-5 ">
                <h3 className="text-gray-500 text-xs pt-3 font-medium px-5 mb-3 ">
                  CONTENT
                </h3>
                <li className={active == 'content' ? 'py-2 px-5  text-sm  hover:bg-blue-50 cont active ': 'py-2 px-5  text-sm  hover:bg-blue-50'}  onClick={ () =>setActive('content')} >
                  <Link to="/content">Videos</Link>
                </li>
                <li className={active == 'liveevent' ? 'py-2 px-5  text-sm  hover:bg-blue-50 cont active ': 'py-2 px-5  text-sm  hover:bg-blue-50'}  onClick={ () =>setActive('liveevent')}>
                  <Link to="/liveevent">Live Events</Link>
                </li>
                <li className={active == 'collection' ? 'py-2 px-5  text-sm  hover:bg-blue-50 cont active ': 'py-2 px-5  text-sm  hover:bg-blue-50'}  onClick={ () =>setActive('collection')}>
                <Link to="/collection">Collections</Link>
                </li>
                <li className={active == 'extras' ? 'py-2 px-5  text-sm  hover:bg-blue-50 cont active ': 'py-2 px-5  text-sm  hover:bg-blue-50'}  onClick={ () =>setActive('extras')}>
            ...
            <div className="flex pb-10">
              <ul className="text-sm leading-5 ">
                ...
                <li className={active == 'categories' ? 'py-2 px-5  text-sm  hover:bg-blue-50 cont active ': 'py-2 px-5  text-sm  hover:bg-blue-50'}  onClick={ () =>setActive('categories')}>
                <Link to="/categories">Categories</Link>
                </li>
                <li className={active == 'custom' ? 'py-2 px-5  text-sm  hover:bg-blue-50 cont active ': 'py-2 px-5  text-sm  hover:bg-blue-50'}  onClick={ () =>setActive('custom')}>
                <Link to="/custom">Custom filters</Link>
                </li>
                <li className={active == 'author' ? 'py-2 px-5  text-sm  hover:bg-blue-50 cont active ': 'py-2 px-5  text-sm  hover:bg-blue-50'}  onClick={ () =>setActive('author')}>
                    ...
                    <a href="#" className="pr-3">
                     ...
                     <a  href="" className="pr-3">
                      ...
                      >
                         ...
                         msg2={['Pay special attention to the Pricing and Publication options when uploading your' ,'videos.']} 
         name="Take a tour"/>  
                      </span>
